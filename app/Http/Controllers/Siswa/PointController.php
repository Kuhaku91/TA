...
class PointController extends Controller
{
    public function Point(){
    	...
    	// dd($data);
        return view('Siswa.Point.point',compact('data'));
    }
    ...
    public function PointGuru(){
        ...
        // dd($data);
        return view('Siswa.Point.pointguru',compact('data'));
    }
    ...
    public function DPoint(){
        ...
        return view('Siswa.Point.dpoint',compact('data'));
    }
    ...
    public function CDPoint($id){
        ...
        // dd($data);
        return view('Siswa.Point.cpoint',compact('data'));
    }
    ...
    public function TCDPoint(Request $r,$id){
        ...
        return redirect('siswa/point/'.$id);
    }
    ...
    public function PPoint()
    {
        ...
        return view('Siswa.Point.laporan',compact('data'));
        // dd($data);
    }
    ...
    public function CPlapor($id)
    {
        ...
        return view('Siswa.Point.claporan',compact('data'));
    }
    ...
    {   
        ...
        return redirect('siswa/plapor/'.$id);
    }
}
