		...
		<div class="col-12 d-flex no-block align-items-center">
			...
			<div class="ml-auto text-right">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{route('GuruPointSiswa')}}">Point</a></li>
				...
				<form class="form-horizontal" action="{{url('guru/lapor/')}}" method="post" enctype="multipart/form-data">
					...
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<select class="select2 form-control custom-select" id="jurusan" name="jurusan" style="width: 100%; height:36px;">
