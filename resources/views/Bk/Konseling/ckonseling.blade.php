		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body border-top">
					<form class="row" action="{{url('bk/konseling',$data['id'])}}" method="post">
						@csrf
						<div class="col-9">
						...
						<div class="col-3">
							<button class="btn-circle btn-lg btn-cyan float-right text-white" name="id_penerima" value="{{$data['id_penerima']->id_siswa}}">
