...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-12 d-flex no-block align-items-center">
			<h4 class="page-title">Chat Pelapor</h4>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Chat Laporan Siswa</h4>
					<div class="chat-box scrollable" style="height:475px;">
						...
						<ul class="chat-list">
							...
							<li class="odd chat-item">
								...
								<div class="chat-time">
									<?= DATE('H:i',strtotime($chat->created_at)+60*60*7); ?>
								</div>
							</li>
				...
				<div class="card-body border-top">
					<form class="row" action="{{url('bk/plapor',$data['id'])}}" method="post">
						@csrf
						<div class="col-9">
						...
						<div class="col-3">
							<button class="btn-circle btn-lg btn-cyan float-right text-white" name="id_penerima" value="{{$data['id_pelapor']->id_pelapor}}">
