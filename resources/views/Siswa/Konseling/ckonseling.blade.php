...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Chat Konsul</h4>
					<div class="chat-box scrollable" style="height:475px;">
						...
						<ul class="chat-list">
							...
							@elseif($chat->id_pengirim!=Auth()->user()->id)
							<!--chat Row -->
							<li class="chat-item">
				...
				<div class="card-body border-top">
					<form class="row" action="{{url('siswa/konseling',$data['id'])}}" method="post">
						@csrf
						<div class="col-9">
						...
						<div class="col-3">
							<button class="btn-circle btn-lg btn-cyan float-right text-white" name="id_penerima" value="{{$data['id_penerima']->id_guru}}">
