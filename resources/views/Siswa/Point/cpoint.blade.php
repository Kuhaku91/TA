...
<div class="page-breadcrumb">
	<div class="row">
		<div class="col-12 d-flex no-block align-items-center">
			<h4 class="page-title">Chat Point</h4>
			<div class="ml-auto text-right">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{route('DataSiswaPoint')}}">Chat Point</a></li>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Chat Point</h4>
				...
				<div class="card-body border-top">
					<form class="row" action="{{url('siswa/point',$data['id'])}}" method="post">
						@csrf
						<div class="col-9">
						...
						<div class="col-3">
							<button class="btn-circle btn-lg btn-cyan float-right text-white" name="id_penerima" value="0">
