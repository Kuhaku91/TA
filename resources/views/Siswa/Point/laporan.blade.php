		...
		<div class="col-12 d-flex no-block align-items-center">
			...
			<div class="ml-auto text-right">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{route('SiswaPointLapor')}}">POINT</a></li>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="{{ url('siswa/plapor',$lapor->id) }}" class="btn btn-info btn-sm">Chat</a>
										@if($lapor->verif=='s')
										<button class="btn btn-success btn-sm">Sudah Terverifikasi</button>
										@else
