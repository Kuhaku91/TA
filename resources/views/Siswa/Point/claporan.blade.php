		...
		<div class="col-12 d-flex no-block align-items-center">
			...
			<div class="ml-auto text-right">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="{{route('SiswaPointLapor')}}">Chat Point</a></li>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Chat Laporan</h4>
				...
				<div class="card-body border-top">
					<form class="row" action="{{url('siswa/plapor',$data['id'])}}" method="post">
						@csrf
						<div class="col-9">
